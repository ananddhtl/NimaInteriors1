                ...
                <div class="container my-auto py-5">
                    <div class="row">
                        <div class="col-lg-9 col-xl-7 mx-auto position-relative">
                            <form action="{{ route_with_locale('customer.login.post') }}" class="input_style_1" method="post">
                                @csrf
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="float-end">
                                        <a class="ml-2" id="forgot" href="{{ route_with_locale('customer.forgotpassword') }}">Forgot
                                            Password?</a>
                                    </div>
                                </div>
                            ...
                            <p class="text-center mt-3 mb-0">Don't have an account? <a
                                    href="{{route_with_locale('customer.register')}}">Sign Up</a></p>
