                        ...
                        <table class="table mb-0">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    {{-- <th><button type="button" class="btn btn-info waves-effect waves-light"><i
                                                class="mdi mdi-pen"></i></button>&nbsp;<button type="button"
                                    ...
                                    <th> <a href="{{ route('admin.editproject', $item->id) }}"
                                        ...
                                        <a href="{{ route('admin.deleteproject', $item->id) }}"
                                            class="btn btn-danger waves-effect waves-light"><i
